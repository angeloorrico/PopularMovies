...
public class TrailerTask extends AsyncTask<String, Void, TrailerResponseModel> {
    ...
    @Override
    protected TrailerResponseModel doInBackground(String... params) {
        try {
            return mServicesEndpoints.fetchTrailers(params[0],
                    BuildConfig.API_KEY,
    ...
    @Override
    protected void onPostExecute(TrailerResponseModel responseModel) {
